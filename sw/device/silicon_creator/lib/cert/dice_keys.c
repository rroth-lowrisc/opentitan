...
// UDS (Creator) attestation key diversified constants.
...
// CDI_0 (OwnerIntermediate) attestation key diversified constants.
...
// CDI_1 (Owner) attestation key diversified constants.
