...
tl_if sram_ctrl_ret__regs_tl_if(clk_io_div4, rst_n);
tl_if sram_ctrl_ret__ram_tl_if(clk_io_div4, rst_n);
tl_if aon_timer_tl_if(clk_io_div4, rst_n);
tl_if sysrst_ctrl_tl_if(clk_io_div4, rst_n);
tl_if adc_ctrl_tl_if(clk_io_div4, rst_n);
