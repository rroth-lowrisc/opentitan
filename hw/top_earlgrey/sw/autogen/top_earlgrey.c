...
const top_earlgrey_alert_peripheral_t
  ...
  [kTopEarlgreyAlertIdAdcCtrlFatalFault] = kTopEarlgreyAlertPeripheralAdcCtrl,
  [kTopEarlgreyAlertIdPinmuxFatalFault] = kTopEarlgreyAlertPeripheralPinmux,
  [kTopEarlgreyAlertIdAonTimerFatalFault] = kTopEarlgreyAlertPeripheralAonTimer,
...
const top_earlgrey_plic_peripheral_t
  ...
  [kTopEarlgreyPlicIrqIdAonTimerWkupTimerExpired] = kTopEarlgreyPlicPeripheralAonTimer,
