...
module keymgr_dpe_reg_top (
  ...
  logic kdf_engine_we;
  logic [3:0] kdf_engine_qs;
  logic [3:0] kdf_engine_wd;
  ...
  // R[kdf_engine]: V(False)
  // Create REGWEN-gated WE signal
  logic kdf_engine_gated_we;
  assign kdf_engine_gated_we = kdf_engine_we & kdf_engine_regwen_qs;
  prim_subreg #(
    .DW      (4),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (4'h9),
  ...
  always_comb begin
    ...
    addr_hit[ 3] = (reg_addr == KEYMGR_DPE_ALERT_TEST_OFFSET);
    addr_hit[ 4] = (reg_addr == KEYMGR_DPE_CFG_REGWEN_OFFSET);
    addr_hit[ 5] = (reg_addr == KEYMGR_DPE_START_OFFSET);
    addr_hit[ 6] = (reg_addr == KEYMGR_DPE_CONTROL_SHADOWED_OFFSET);
    ...
    addr_hit[11] = (reg_addr == KEYMGR_DPE_KDF_ENGINE_OFFSET);
  ...
  always_comb begin
    wr_err = (reg_we &
              ((addr_hit[ 0] & (|(KEYMGR_DPE_PERMIT[ 0] & ~reg_be))) |
               (addr_hit[ 1] & (|(KEYMGR_DPE_PERMIT[ 1] & ~reg_be))) |
               (addr_hit[ 2] & (|(KEYMGR_DPE_PERMIT[ 2] & ~reg_be))) |
               (addr_hit[ 3] & (|(KEYMGR_DPE_PERMIT[ 3] & ~reg_be))) |
               (addr_hit[ 4] & (|(KEYMGR_DPE_PERMIT[ 4] & ~reg_be))) |
               (addr_hit[ 5] & (|(KEYMGR_DPE_PERMIT[ 5] & ~reg_be))) |
               (addr_hit[ 6] & (|(KEYMGR_DPE_PERMIT[ 6] & ~reg_be))) |
               (addr_hit[ 7] & (|(KEYMGR_DPE_PERMIT[ 7] & ~reg_be))) |
               (addr_hit[ 8] & (|(KEYMGR_DPE_PERMIT[ 8] & ~reg_be))) |
               (addr_hit[ 9] & (|(KEYMGR_DPE_PERMIT[ 9] & ~reg_be))) |
               (addr_hit[10] & (|(KEYMGR_DPE_PERMIT[10] & ~reg_be))) |
               (addr_hit[11] & (|(KEYMGR_DPE_PERMIT[11] & ~reg_be))) |
               (addr_hit[12] & (|(KEYMGR_DPE_PERMIT[12] & ~reg_be))) |
               (addr_hit[13] & (|(KEYMGR_DPE_PERMIT[13] & ~reg_be))) |
               (addr_hit[14] & (|(KEYMGR_DPE_PERMIT[14] & ~reg_be))) |
               (addr_hit[15] & (|(KEYMGR_DPE_PERMIT[15] & ~reg_be))) |
               (addr_hit[16] & (|(KEYMGR_DPE_PERMIT[16] & ~reg_be))) |
               (addr_hit[17] & (|(KEYMGR_DPE_PERMIT[17] & ~reg_be))) |
               (addr_hit[18] & (|(KEYMGR_DPE_PERMIT[18] & ~reg_be))) |
               (addr_hit[19] & (|(KEYMGR_DPE_PERMIT[19] & ~reg_be))) |
               (addr_hit[20] & (|(KEYMGR_DPE_PERMIT[20] & ~reg_be))) |
               (addr_hit[21] & (|(KEYMGR_DPE_PERMIT[21] & ~reg_be))) |
               (addr_hit[22] & (|(KEYMGR_DPE_PERMIT[22] & ~reg_be))) |
               (addr_hit[23] & (|(KEYMGR_DPE_PERMIT[23] & ~reg_be))) |
               (addr_hit[24] & (|(KEYMGR_DPE_PERMIT[24] & ~reg_be))) |
               (addr_hit[25] & (|(KEYMGR_DPE_PERMIT[25] & ~reg_be))) |
               (addr_hit[26] & (|(KEYMGR_DPE_PERMIT[26] & ~reg_be))) |
               (addr_hit[27] & (|(KEYMGR_DPE_PERMIT[27] & ~reg_be))) |
               (addr_hit[28] & (|(KEYMGR_DPE_PERMIT[28] & ~reg_be))) |
               (addr_hit[29] & (|(KEYMGR_DPE_PERMIT[29] & ~reg_be))) |
               (addr_hit[30] & (|(KEYMGR_DPE_PERMIT[30] & ~reg_be))) |
               (addr_hit[31] & (|(KEYMGR_DPE_PERMIT[31] & ~reg_be))) |
               (addr_hit[32] & (|(KEYMGR_DPE_PERMIT[32] & ~reg_be))) |
               (addr_hit[33] & (|(KEYMGR_DPE_PERMIT[33] & ~reg_be))) |
               (addr_hit[34] & (|(KEYMGR_DPE_PERMIT[34] & ~reg_be))) |
               (addr_hit[35] & (|(KEYMGR_DPE_PERMIT[35] & ~reg_be))) |
               (addr_hit[36] & (|(KEYMGR_DPE_PERMIT[36] & ~reg_be))) |
               (addr_hit[37] & (|(KEYMGR_DPE_PERMIT[37] & ~reg_be))) |
               (addr_hit[38] & (|(KEYMGR_DPE_PERMIT[38] & ~reg_be))) |
               (addr_hit[39] & (|(KEYMGR_DPE_PERMIT[39] & ~reg_be))) |
               (addr_hit[40] & (|(KEYMGR_DPE_PERMIT[40] & ~reg_be))) |
               (addr_hit[41] & (|(KEYMGR_DPE_PERMIT[41] & ~reg_be))) |
               (addr_hit[42] & (|(KEYMGR_DPE_PERMIT[42] & ~reg_be))) |
               (addr_hit[43] & (|(KEYMGR_DPE_PERMIT[43] & ~reg_be))) |
               (addr_hit[44] & (|(KEYMGR_DPE_PERMIT[44] & ~reg_be))) |
               (addr_hit[45] & (|(KEYMGR_DPE_PERMIT[45] & ~reg_be))) |
               (addr_hit[46] & (|(KEYMGR_DPE_PERMIT[46] & ~reg_be))) |
               (addr_hit[47] & (|(KEYMGR_DPE_PERMIT[47] & ~reg_be))) |
               (addr_hit[48] & (|(KEYMGR_DPE_PERMIT[48] & ~reg_be))) |
  ...
  assign kdf_engine_we = addr_hit[11] & reg_we & !reg_error;

  assign kdf_engine_wd = reg_wdata[3:0];
  ...
  always_comb begin
    ...
    reg_we_check[11] = kdf_engine_gated_we;
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[11]: begin
        reg_rdata_next[3:0] = kdf_engine_qs;
      end
