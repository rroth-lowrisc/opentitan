...
package keymgr_dpe_reg_pkg;
  ...
  typedef struct packed {
    logic [3:0]  q;
  } keymgr_dpe_reg2hw_kdf_engine_reg_t;
  ...
  parameter logic [BlockAw-1:0] KEYMGR_DPE_KDF_ENGINE_OFFSET = 8'h 2c;
  ...
  parameter logic [3:0] KEYMGR_DPE_PERMIT [56] = '{
    ...
    4'b 0001, // index[11] KEYMGR_DPE_KDF_ENGINE
